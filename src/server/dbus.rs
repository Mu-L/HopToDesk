...
///
/// Note:
/// On linux, we use dbus to communicate multiple hoptodesk process.
...
impl fmt::Display for DbusError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "HopToDesk DBus Error: {}", self.0)
    }
}
...
/// `dbus-send --session --print-reply --dest=org.hoptodesk.hoptodesk /dbus org.hoptodesk.hoptodesk.NewConnection string:'PEER_ID'`
