...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Configure", "Configura"),
        ("config_acc", "Per controllare il tuo desktop dall'esterno, devi fornire a HopToDesk il permesso \"Accessibilità\"."),
        ("config_screen", "Per controllare il tuo desktop dall'esterno, devi fornire a HopToDesk il permesso \"Registrazione schermo\"."),
        ...
        ("android_input_permission_tip1", "Affinché un dispositivo remoto possa controllare il tuo dispositivo Android tramite mouse o tocco, devi consentire a HopToDesk di utilizzare il servizio \"Accessibilità\"."),
        ("android_input_permission_tip2", "Vai alla pagina delle impostazioni di sistema successiva, trova e accedi a [Servizi installati], attiva il servizio [HopToDesk Input]."),
        ...
        ("android_open_battery_optimizations_tip", "Se si desidera disabilitare questa funzione, andare nelle impostazioni dell'applicazione HopToDesk, aprire la sezione [Batteria] e deselezionare [Senza restrizioni]."),
        ...
        ("Show HopToDesk", "Mostra HopToDesk"),
        ("This PC", "Questo PC"),
        ("or", "O"),
        ...
        ("config_input", "Per controllare il desktop remoto con la tastiera, è necessario concedere le autorizzazioni a HopToDesk \"Monitoraggio dell'input\"."),
        ("config_microphone", ""),
        ...
        ("still_click_uac_tip", "Richiede ancora che l'utente remoto faccia clic su OK nella finestra UAC dell'esecuzione di HopToDesk."),
