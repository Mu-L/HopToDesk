...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Error", "fejl"),
        ("Connection lost", "Nulstil ved peer"),
        ...
        ("install_tip", "For at opnå den bedste ydeevne skal du fuldføre en komplet installation."),
        ...
        ("Forget Password", "Bemærk ikke adgangskoden"),
        ("Favorites", "Favorit"),
        ...
        ("android_input_permission_tip2", "Gå til den næste systemindstillingsside, søg og indtast [installerede tjenester], tænd for [HopToDesk Input] Service."),
