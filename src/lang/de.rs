...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("config_input", "Um den entfernten Desktop mit der Tastatur steuern zu können, müssen Sie HopToDesk die Berechtigung \"Input Monitoring\" erteilen."),
        ...
        ("still_click_uac_tip", "Der entfernte Benutzer muss immer noch im UAC-Fenster von HopToDesk auf OK klicken."),
        ...
        ("confirm_idd_driver_tip", "Die Option zur Installation des virtuellen Anzeigetreibers ist aktiviert. Beachten Sie, dass ein Testzertifikat installiert wird, um dem virtuellen Anzeigetreiber zu vertrauen. Dieses Testzertifikat wird nur verwendet, um HopToDesk-Treibern zu vertrauen."),
