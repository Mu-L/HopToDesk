...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Führen Sie für eine optimale Leistung eine vollständige Installation durch."),
        ...
        ("config_screen", "Um aus der Ferne auf Ihren PC zugreifen zu können, müssen Sie HopToDesk \"Bildschirm-Aufnahme\"-Berechtigung erteilen."),
        ...
        ("android_input_permission_tip1", "Damit ein Remote-Gerät Ihr Android-Gerät steuern kann, müssen Sie HopToDesk erlauben, den Dienst \"Barrierefreiheit\" zu verwenden."),
        ("android_input_permission_tip2", "Bitte gehen Sie zur nächsten Systemeinstellungsseite, suchen und geben Sie [Installierte Dienste] ein, schalten Sie den Dienst [HopToDesk Input] ein."),
