...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
       ...
       ("whitelist_tip", "Somente IPs confiáveis podem me acessar"),
        ...
        ("Trust this device", "Confiar nesse dispositivo"),
        ...
        ("Failed", "Falhou"),
        ("Succeeded", "Sucesso"),
        ("Someone turned on privacy mode, exit", "Alguém ativou o modo de privacidade, por favor desconecte"),
        ...
        ("Right click to select tabs", "Clique com botão direto para selecionar as guias"),
        ("Skipped", ""),
        ("Add to Address Book", "Adicionar ao livro de endereços"),
        ("Group", "grupo"),
        ("Search", "Procurar"),
        ("Closed manually by web console", "Fechado manualmente pelo web console"),
        ("Local keyboard type", "Tipo de teclado local"),
        ("Select local keyboard type", "Selecione o tipo de teclado local"),
        ("software_render_tip", ""),
        ("Always use software rendering", "Sempre usar renderização de software"),
        ("config_input", "Confifgurações de entrada"),
        ("request_elevation_tip", ""),
        ("Wait", "Aguarde"),
        ("Elevation Error", "Erro de elevação"),
        ("Ask the remote user for authentication", "Pedir autenticação ao usuário remoto"),
        ("Choose this if the remote account is administrator", "Escolha isso se a conta remota for administrador"),
        ("Transmit the username and password of administrator", "Transmita o nome de usuário e senha de administrador"),
        ("still_click_uac_tip", ""),
        ("Request Elevation", ""),
        ("wait_accept_uac_tip", ""),
