...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Unable to connect to the remote partner.", "Não é possível se conectar ao parceiro remoto."),
        ...
        ("config_acc", "Para controlar seu Desktop remotamente, você precisa conceder ao HopToDesk permissões de \"Acessibilidade\"."),
        ("config_screen", "Para acessar seu Desktop remotamente, você precisa conceder ao HopToDesk permissões de \"Gravar a Tela\"/"),
		...
		("Change Display", "Alterar Exibição"),				
        ...
        ("Failed", "Falhou"),
        ("Succeeded", "Conseguiu"),
        ("Someone turned on privacy mode, exit", "Alguém liga o modo de privacidade, saia"),
