...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Key mismatch", "金鑰不符"),
        ("Timeout", "逾時"),
        ("Unable to connect to the remote partner.", "無法連接到遠程夥伴。"),
        ...
        ("Username", " 使用者名稱"),
        ("Invalid port", "連接埠無效"),
        ("The remote partner has closed the session.", "由對方手動關閉"),
        ...
        ("android_input_permission_tip2", "請在接下來的系統設定頁面中，找到並進入 ｢已安裝的服務｣ 頁面，並將 ｢HopToDesk Input｣ 服務開啟"),
        ...
        ("android_open_battery_optimizations_tip", "如需關閉此功能，請在接下來的HopToDesk應用設置頁面中，找到並進入 [電源] 頁面，取消勾選 [不受限制]"),
       ...
       ("Legacy mode", "傳統模式"),
        ...
        ("config_input", "為了能夠通過鍵盤控制遠程桌面, 請給予 HopToDesk \"輸入監控\" 權限。"),
        ("config_microphone", "為了支持通過麥克風進行音訊傳輸，請給予 HopToDesk \"錄音\"權限。"),
