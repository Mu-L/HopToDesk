...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Unable to connect to the remote partner.", "Nepodařil se připojit ke zprostředkovávajícímu serveru"),
        ...
        ("Configure", "Nastavit"),
        ("config_acc", "Chcete-li používat sdílení obrazovky, povolte oprávnění \"Přístupnost\"."),
        ("config_screen", "Chcete-li používat sdílení obrazovky, povolte oprávnění \"Nahrávání obrazovky\"."),
        ...
        ("Forget Password", "Přestat si heslo pamatovat"),
        ("Favorites", "Oblíbené"),
        ...
        ("Succeeded", "Uspěl"),
        ("Someone turned on privacy mode, exiting.", "Někdo zapne režim soukromí, ukončete ho"),
