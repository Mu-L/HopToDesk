...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Unable to connect to the remote partner.", "Не удалось подключиться к промежуточному серверу"),
        ...
        ("Unable to connect to the remote partner.", "Не удается подключиться к удаленному партнеру."),
        ...
        ("Configure", "Настроить"),
        ("config_acc", "Чтобы удаленно управлять своим рабочим столом, вы должны предоставить HopToDesk права \"доступа\""),
        ("config_screen", "Для удаленного доступа к рабочему столу вы должны предоставить HopToDesk права \"снимок экрана\""),
        ...
        ("A new update is available.", "Ваша инсталяция является более ранней версией"),
		...
		("Change Display", "Изменить дисплей"),		
        ...
        ("android_input_permission_tip1", "Чтобы удаленное устройство могло управлять вашим Android-устройством с помощью мыши или касания, вам необходимо разрешить HopToDesk использовать службу «Специальные возможности»."),
        ...
        ("Keep HopToDesk background service", "Сохранить фоновый службу HopToDesk"),
